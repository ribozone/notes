...
modified: 2025-04-16T20:05:27-04:00
...
- [jam page on itch](https://itch.io/jam/discmaster-jam)
...
- greenhouse idea:  [greenhouse.wad](https://discmaster.textfiles.com/browse/20919/WADS_D2.iso/doom2/deathmatch/gtoi/greenhouse.zip/Greenhouse.WAD) + [godot wad importer](https://github.com/DataPlusProgram/GodotWadImporter)? (do not do this until the jam starts)
...
- read [godot docs > getting started > step by step](https://docs.godotengine.org/en/stable/getting_started/step_by_step/index.html)
	...
	- using signals -- ack
		...
		- got the animation toggle button working, but now i'm really bored. the next sections are about timers and health bars, which don't feel relevant to what i'm trying to make, so i'll skip them for now
...
- [icons](https://discmaster.textfiles.com/browse/1090/CU%20Amiga%20Magazine's%20Super%20CD-ROM%2017%20(1997)(EMAP%20Images)(GB)[!][issue%201997-12].iso/CoolWB/Icons/MagicWB/mwbarchive/tools) 📁
